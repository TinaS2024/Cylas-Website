...
const Subnavbar = () =>
{
    return (
        ...
        <div id="subnav" className="nav-container abstand-unten" style={{height: "60px",marginTop:"-5px",backgroundImage: "linear-gradient(to bottom,#286464,#2a8889 99%"}}> {/*  backgroundColor:"#2a8889"*/}
